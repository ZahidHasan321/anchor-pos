<script lang="ts">
	...
	import { ChevronLeft, Save, Loader2, User, Phone, Mail, Shield, Image as ImageIcon, Camera } from '@lucide/svelte';
...
<div class="space-y-6 p-3 sm:p-6">
	<div class="flex items-center gap-4">
		...
		<div>
			...
			<p class="text-sm text-muted-foreground sm:text-base">View and edit staff profile information.</p>
		</div>
	</div>
					...
					<Card.Content class="pt-6">
						<div class="flex flex-col items-center text-center">
							...
							<div class="mt-4 flex flex-wrap justify-center gap-2">
								...
								<span
									class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {data.user.isActive ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'}"
								>
							...
							<div class="grid gap-6 md:grid-cols-2">
								<div class="space-y-2">
									...
									<div class="relative">
										...
										<Input id="email" name="email" type="email" value={data.user.email} class="pl-10" />
									</div>
								</div>
