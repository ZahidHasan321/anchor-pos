						...
						<div class="grid grid-cols-[repeat(auto-fill,minmax(240px,1fr))] gap-2 sm:gap-3">
							{#each displayedProducts as variant (variant.id)}
								...
								<button
									...
									class="group relative flex w-full cursor-pointer flex-col rounded-xl border bg-card p-3 shadow-sm transition-all hover:shadow-lg active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 {cartQty >
									0
...
>
	<Dialog.Content class="max-w-md overflow-hidden p-0">
		...
		<div class="space-y-4 px-5 pb-5">
			...
			<div class="grid grid-cols-4 gap-0.5 rounded-lg bg-muted p-1">
